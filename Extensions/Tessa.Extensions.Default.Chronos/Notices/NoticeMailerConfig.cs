...
namespace Tessa.Extensions.Default.Chronos.Notices
{
    public static class NoticeMailerConfig
    {
        ...
        public const string NoticeMailer_SmtpTargetName_PropertyName = "NoticeMailer.SmtpTargetName";
        ...
        public static string SmtpTargetName => GetSetting<string>(NoticeMailer_SmtpTargetName_PropertyName);
