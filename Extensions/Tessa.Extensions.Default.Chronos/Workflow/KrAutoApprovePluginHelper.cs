...
namespace Tessa.Extensions.Default.Chronos.Workflow
{
    public static class KrAutoApprovePluginHelper
    {
                ...
                .SetCommand(
                    builderFactory
                        ...
                        .LeftJoin("DocumentCommonInfo", "dci").NoLock()
                            .On().C("dci", "ID").Equals().C("tsk", "ID")
                        .LeftJoin("KrDocType", "kdt").NoLock()
                            .On().C("kdt", "ID").Equals().C("dci", "DocTypeID")
                        .Where().C("tsk", "TypeID").Equals().P("TaskTypeID")
                            .And().C("krs", "StageTypeID").Equals().V(StageTypeDescriptors.ApprovalDescriptor.ID)
                            .And(b => b
                                .E(e => e
                                            ...
                                            v => v.Q(" DATEADD(minute, -").C("tsk", "TimeZoneUtcOffsetMinutes").Q(", ")
                                                .Function("CalendarAddWorkingDaysToDate",
                                                    p => InsertPlannedWithOffset(p)
                                                        .C("sct", "ExceededDays")).Q(") "))
                                        .ElseIf(Dbms.PostgreSql,
                                            v => v.Function("CalendarAddWorkingDaysToDate",
                                                    p => InsertPlannedWithOffset(p)
                                                        .C("sct", "ExceededDays"))
                                                .Substract().Q("(").C("tsk", "TimeZoneUtcOffsetMinutes").Q(" * interval '1 minute') "))
                                    .ElseThrow()))
                                .Or()
                                .E(e => e
            ...
            foreach (KrAutoApproveTaskRecord task in tasksToApprove)
            {
                ...
                await transactionStrategy.ExecuteInWriterLockAsync(
                    ...
                    async p =>
                    {
                        ...
                        var dciSection = card.Sections["DocumentCommonInfo"];
                        string cardNumber = null;
                        string cardSubject = null;
                        if (dciSection != null)
                        {
                            cardNumber = dciSection.Fields.Get<string>("FullNumber");
                            cardSubject = dciSection.Fields.Get<string>("Subject");
                        }
                        ...
                        List<KrAutoApproveAdditionalTaskRecord> additionalApproveTasks =
                            await GetAdditionalApprovalInfoAsync(db, builderFactory, taskID, cancellationToken);
                        ...
                        await AddRowToAutoApproveHistoryAsync(db, builderFactory, cardID, taskID, card.TypeID, card.TypeCaption, digest,
                            taskClosure.ApprovalComment, cancellationToken);
        ...
        private static IQueryBuilder InsertPlannedWithOffset(IQueryBuilder builder)
        {
            return
                builder
                    .E(p => p
                        .If(Dbms.SqlServer,
                            iv => iv.Q(" DATEADD(minute, ").C("tsk", "TimeZoneUtcOffsetMinutes").Q(", ")
                                .C("tsk", "Planned").Q(") "))
                        .ElseIf(Dbms.PostgreSql,
                            iv => iv.C("tsk", "Planned").Add().Q("(")
                                .C("tsk", "TimeZoneUtcOffsetMinutes").Q(" * interval '1 minute') "))
                        .ElseThrow());
        }
            ...
            db
                .SetCommand(
                    builderFactory
                        ...
                        .On().C("tsk", "RoleID").Equals().C("ru", "ID")
                        .Where().C("tsk", "RowID").Equals().P("TaskID")
                        .Build(),
                    ...
                    db.Parameter("CardDigest", SqlHelper.Nullable(cardDigest, 255)),
        ...
        /// </summary>
        /// <param name="responsibleTask">Задание ответсвенного доп. согласанта</param>
        ...
        /// </summary>
        /// <param name="responsibleTaskOrNull">Задание ответсвенного доп. согласанта</param>
