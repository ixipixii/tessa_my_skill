...
namespace Tessa.Extensions.Default.Console.ExportSchemeSql
{
    public static class Command
    {
        ...
        public static async Task ExportSchemeSql(
            ...
            [Argument("u"), LocalizableDescription("Common_CLI_UpgradeSchemeInDatabase")] bool upgradeDbScheme = false,
            ...
            [Argument("nologo")] [LocalizableDescription("CLI_NoLogo")] bool nologo = false)
        {
            ...
            int result = await Operation.ExecuteAsync(logger, outputFolder, upgradeDbScheme, configurationString, databaseName);
