...
namespace Tessa.Extensions.Default.Client.Tiles
{
    public static class KrTileHelper
    {
        ...
        public static async ValueTask<ReadOnlyCollection<Guid>> GetUnavailableTypesAsync(
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            {
                return unavaiableTypeIDList;
            }

            return unavaiableTypeIDList = await KrPermissionsHelper.GetUnavailableTypesAsync(
