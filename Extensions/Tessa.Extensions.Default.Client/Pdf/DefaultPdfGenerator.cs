...
namespace Tessa.Extensions.Default.Client.Pdf
{
        ...
        IPdfGenerator
    {
        ...
        public virtual async Task<ScanDocument> TryGenerateAsync(IPdfGeneratorContext context, CancellationToken cancellationToken = default)
        {
            ...
            await context.PngPageFiles
                ...
                .RunWithMaxDegreeOfParallelismAsync(
                    ...
                    async (x, ct) =>
                    {
                        ...
                        ScanDocumentHelper.EncodeInJpeg(x.PngFile.Path, jpegFile.Path);
            ...
            IExtensionExecutor<IPdfStampExtension> stampExecutor = null;
            ...
            try
            {
                    ...
                    && (model = editor.CardModel) != null)
                {
                    ...
                    await stampExecutor.ExecuteAsync(x => x.OnGenerationStarted, stampContext).ConfigureAwait(false);
                }
                ...
                for (int i = 0; i < context.PngPageFiles.Count; i++)
                {
                    ...
                    try
                    {
                        ...
                        if (stampContext != null)
                        {
                            ...
                            await stampExecutor.ExecuteAsync(x => x.GenerateForPage, stampContext).ConfigureAwait(false);
                ...
                if (stampContext != null)
                {
                    ...
                    await stampExecutor.ExecuteAsync(x => x.OnGenerationEnded, stampContext).ConfigureAwait(false);
                }
