    ...
    public sealed class WfResolutionVisualizationVisitor
    {
        ...
        private sealed class TreeLevel
        {
                ...
                IList<CardTaskHistoryItem> children = null)
            {
                ...
                this.Children = children ?? EmptyHolder<CardTaskHistoryItem>.Array;
                this.ChildIndex = 0;
                return this;
            }
        ...
        private IList<CardTaskHistoryItem> GetChildrenHistoryItems(Guid parentRowID)
        {
            ...
            for (int i = 0; i < items.Length; i++)
            {
                if (items[i].ParentRowID == parentRowID)
                {
                    if (children is null)
                    {
                        if (historyItemListPool is null)
                        {
            ...
            return (IList<CardTaskHistoryItem>)children
                ?? EmptyHolder<CardTaskHistoryItem>.Array;
        }
        ...
        private CardTaskHistoryItem[] GetHistoryItems()
        {
            ...
            return this.historyItems =
                (taskHistory != null && taskHistory.Count > 0
                    ? taskHistory.ToArray()
                    : EmptyHolder<CardTaskHistoryItem>.Array);
        }
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            {
                throw new ArgumentNullException(nameof(rootHistoryItem));
            }
            ...
            IExtensionExecutor<IWfResolutionVisualizationExtension> executor =
            ...
            try
            {
                if (executor != null)
                {
                    await executor.ExecuteAsync(x => x.OnVisualizationStarted, context, continueOnCapturedContext: true);
                }
                ...
                while (levels.Count > 0)
                {
                    ...
                    if (executor != null)
                    {
                        await executor.ExecuteAsync(x => x.OnNodeGenerating, context, continueOnCapturedContext: true);
                    }
                    ...
                    if (executor != null)
                    {
                        await executor.ExecuteAsync(x => x.OnNodeGenerated, context, continueOnCapturedContext: true);
                ...
                if (executor != null)
                {
                    await executor.ExecuteAsync(x => x.OnVisualizationCompleted, context, continueOnCapturedContext: true);
                }
            }
            finally
            {
