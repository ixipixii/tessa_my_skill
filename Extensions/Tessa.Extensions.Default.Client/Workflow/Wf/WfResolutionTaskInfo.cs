...
namespace Tessa.Extensions.Default.Client.Workflow.Wf
{
    ...
    public sealed class WfResolutionTaskInfo
    {
        ...
        private IFormViewModel cachedForMainInfoForm;

        private IBlockViewModel cachedMainInfoBlock;

        private IFormViewModel cachedForPerformersForm;

        private IBlockViewModel cachedPerformersBlock;

        private IBlockViewModel TryGetBlock(string blockName, ref IFormViewModel cachedForm, ref IBlockViewModel cachedBlock)
        {
            IFormViewModel form = this.control.Workspace.Form;
            if (form == null)
            {
                return null;
            }
