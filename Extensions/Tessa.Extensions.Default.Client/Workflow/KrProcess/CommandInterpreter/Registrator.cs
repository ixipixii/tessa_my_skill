    ...
    public sealed class Registrator : RegistratorBase
    {
        public override void RegisterUnity()
        {
            this.UnityContainer
                ...
                .RegisterType<IClientCommandHandler, AdvancedDialogCommandHandler>(new ContainerControlledLifetimeManager())
        ...
        public override void FinalizeRegistration()
        {
            this.UnityContainer
                ...
                .RegisterHandler<AdvancedDialogCommandHandler>(DefaultCommandTypes.ShowAdvancedDialog)
