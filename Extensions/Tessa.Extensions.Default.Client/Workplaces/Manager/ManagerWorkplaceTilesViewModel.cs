...
namespace Tessa.Extensions.Default.Client.Workplaces.Manager
{
    ...
    public sealed class ManagerWorkplaceTilesViewModel : ViewModel<EmptyModel>
    {
        ...
        ///     The models.
        /// </summary>
        private List<IDictionary<string, object>> models;
        ...
        ///     The selector.
        /// </summary>
        private SelectorViewModel<IDictionary<string, object>, ManagerWorkplaceTileViewModel> selector;
        ...
        private async void OnRefreshAsync(object sender, PropertyChangedEventArgs e)
        {
            ...
            var metadata = this.component.GetViewMetadata(this.component);
            this.models.Clear();
