...
namespace Tessa.Extensions.Default.Client.Views
{
        ...
        IWorkplaceExtensionSettingsRestore
    {
        ...
        public void Initialize(IWorkplaceViewComponent model) =>
            model.ContentFactories[typeof(CreateCardExtension).Name] = component =>
        ...
        public void Restore(byte[] metadata) =>
            this.settings = ExtensionSettingsSerializationHelper.Deserialize<CreateCardExtensionSettings>(metadata);
