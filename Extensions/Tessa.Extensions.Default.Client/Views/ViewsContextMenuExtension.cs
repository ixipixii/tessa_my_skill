...
namespace Tessa.Extensions.Default.Client.Views
{
    ...
    public sealed class ViewsContextMenuExtension : IWorkplaceViewComponentExtension
    {
        ...
        /// </returns>
        private static Action<ViewContextMenuContext> GetClearFilterMenuAction()
        {
            return c =>
                {
        ...
        ///     Действие создающее элемент меню
        /// </returns>
        private static Action<ViewContextMenuContext> GetFilterMenuAction()
        {
            return c =>
                {
        ...
        ///     Действие создающее элемент меню
        /// </returns>
        private static Action<ViewContextMenuContext> GetRefreshMenuAction()
        {
            return
                c =>
                    {
        ...
        ///     Действие создающее элемент меню
        /// </returns>
        private Action<ViewContextMenuContext> GetOpenCardMenuAction()
        {
            return c =>
                {
