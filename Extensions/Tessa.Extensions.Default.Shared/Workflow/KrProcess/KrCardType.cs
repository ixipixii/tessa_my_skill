...
{
    [Serializable]
    public sealed class KrCardType : StorageObject, IKrType
    {
        #region Constructors
        ...
        private KrCardType(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
        ...
        {
            get { return this.Get<bool>(UseDocTypesKey); }
            set { this.Set(UseDocTypesKey, value); }
        }
