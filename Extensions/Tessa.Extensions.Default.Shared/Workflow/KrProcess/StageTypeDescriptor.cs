...
namespace Tessa.Extensions.Default.Shared.Workflow.KrProcess
{
    public sealed class StageTypeDescriptor
    {
        ...
        public override string ToString() => $"ID = {this.ID}, Caption = {this.Caption}";
        ...
        /// <summary>
        /// Создать декскриптор на основании существующего.
        /// Переопределение идентификатора является обязательным.
        /// </summary>
