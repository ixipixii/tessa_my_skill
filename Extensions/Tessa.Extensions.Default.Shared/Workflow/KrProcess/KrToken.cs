...
namespace Tessa.Extensions.Default.Shared.Workflow.KrProcess
{
    ...
    /// </summary>
    [Serializable]
    public sealed class KrToken :
        CardStorageObject,
        ICloneable
    {
        #region Fields

        private ICollection<KrPermissionFlagDescriptor> permissions;
            ...
            : base(storage)
        {
            ...
            this.Init(PermissionsKey, new List<object>());
        ...
        private KrToken(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
        ...
        public ICollection<KrPermissionFlagDescriptor> Permissions
        {
            ...
            set
            {
                this.Set(PermissionsKey, value.Select(x => x.ID).Cast<object>().ToArray());
        ...
        public IKrPermissionExtendedCardSettings ExtendedCardSettings
        {
            ...
            set
            {
                this.Set(nameof(ExtendedCardSettings), value is StorageObject storageValue ?  storageValue.GetStorage() : (object)value);
        ...
        /// </summary>
        /// <param name="krPermission">Проверяемая настрйока доступа</param>
        ...
        private ICollection<KrPermissionFlagDescriptor> InitPermissions()
        {
            var list = this.Get<ICollection<object>>(PermissionsKey);
