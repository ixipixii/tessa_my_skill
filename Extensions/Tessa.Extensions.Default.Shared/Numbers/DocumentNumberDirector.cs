...
namespace Tessa.Extensions.Default.Shared.Numbers
{
        ...
        NumberDirector
    {
        ...
        protected override Task<string> OnGettingDigestAsync(INumberContext context, CancellationToken cancellationToken = default)
        {
            ...
            return TaskBoxes.Box(result);
        }


        protected override async Task<bool> OnCreatingCardAsync(INumberContext context, CancellationToken cancellationToken = default)
        {
            INumberObject number = context.NumberObject;
            if (number.IsEmpty())
            {
        ...
        protected override async Task<bool> OnPreparingTemplateAsync(INumberContext context, CancellationToken cancellationToken = default)
        {
        ...
        protected override Task<bool> OnClosingTabAsync(INumberContext context, CancellationToken cancellationToken = default) =>
            context.Composer.DereserveNumberAsync(context, context.NumberObject, cancellationToken);


        protected override async Task<bool> OnSavingNewCardAsync(INumberContext context, CancellationToken cancellationToken = default)
        {
        ...
        protected override Task<bool> OnImportingCardAsync(INumberContext context, CancellationToken cancellationToken = default) =>
            context.Composer.AcquireUnreservedNumberAsync(context, context.NumberObject, cancellationToken);


        protected override async Task<bool> OnRegisteringCardAsync(INumberContext context, CancellationToken cancellationToken = default)
        {
        ...
        protected override async Task<bool> OnDeregisteringCardAsync(INumberContext context, CancellationToken cancellationToken = default)
        {
        ...
        protected override Task<bool> OnDeletingCardWithoutBackupAsync(INumberContext context, CancellationToken cancellationToken = default) =>
            ReleaseOnDeletingAsync(context, cancellationToken);


        protected override Task<bool> OnDeletingBackupCardAsync(INumberContext context, CancellationToken cancellationToken = default) =>
            ReleaseOnDeletingAsync(context, cancellationToken);


        private static async Task<bool> ReleaseOnDeletingAsync(INumberContext context, CancellationToken cancellationToken = default)
        {
            INumberObject primaryNumber = await context.Composer.GetNumberAsync(context, NumberTypes.Primary, cancellationToken).ConfigureAwait(false);
            ...
            if (primaryNumberIsSequential && secondaryNumberIsSequential)
            {
                    ...
                    && primaryNumber.SequenceName == secondaryNumber.SequenceName)
                {
                    ...
                    result = type != null && !type.ReleaseRegularNumberOnFinalDeletion
                        || await context.Composer.ReleaseNumberAsync(context, primaryNumber, cancellationToken).ConfigureAwait(false);
                }
                else
                {
                    ...
                    if (type != null)
                    {
                        if (type.UseRegistration && type.ReleaseRegistrationNumberOnFinalDeletion)
                        {
        ...
        protected override async Task<bool> OnReservingNumberFromControlAsync(INumberContext context, CancellationToken cancellationToken = default)
        {
        ...
        protected override async Task<bool> OnReleasingNumberFromControlAsync(INumberContext context, CancellationToken cancellationToken = default)
        {
            if (context.Session.Type == SessionType.Server)
            {
        ...
        private static async ValueTask<KrState?> GetCoreForKrStateAsync(INumberContext context, CancellationToken cancellationToken = default)
        {
            ...
            if (state.HasValue || !context.Card.IsPartiallyLoaded())
            {
                return state;
            }
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            {
                numberFormat = await this.GetFullNumberAsync(context, numberType, number, cancellationToken).ConfigureAwait(false);
            }
        ...
        protected override async Task<string> FormatSequenceNameAsync(
            INumberContext context,
            NumberTypeDescriptor numberType,
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            if (result
                && context.ExternalContext is ICardExtensionContext extensionContext)
            {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            if (context.Session.Type == SessionType.Client)
            {
                ...
                bool isManualAvailable = state == KrState.Registered
                    ? type is null || type.UseRegistration && type.AllowManualRegistrationDocNumberAssignment
            ...
            if (eventType == NumberEventTypes.RegisteringCard)
            {
                return type is null
                    || type.UseRegistration
                    && type.DocNumberRegistrationAutoAssignmentID == KrDocNumberRegistrationAutoAssignmentID.Assign;
            }
            ...
            if (eventType == NumberEventTypes.DeletingBackupCard)
            {
                ...
                return state == KrState.Registered
                    ? type is null
                      || type.UseRegistration && type.ReleaseRegistrationNumberOnFinalDeletion
                      || type.ReleaseRegularNumberOnFinalDeletion
                    : type is null
                      || type.ReleaseRegularNumberOnFinalDeletion;
            }
        ...
        protected override async Task<bool> BeforeGettingDigestAsync(INumberContext context, CancellationToken cancellationToken = default) =>
            await NumberHelper.GetNumberAndSetToContextPredicateAsync(context, NumberTypes.Primary, cancellationToken: cancellationToken).ConfigureAwait(false);

        protected override async Task<bool> BeforeClosingTabAsync(INumberContext context, CancellationToken cancellationToken = default) =>
            await NumberHelper.GetNumberAndSetToContextPredicateAsync(context, NumberTypes.Primary, cancellationToken: cancellationToken).ConfigureAwait(false);

        protected override async Task<bool> BeforeImportingCardAsync(INumberContext context, CancellationToken cancellationToken = default) =>
            await NumberHelper.GetNumberAndSetToContextPredicateAsync(context, NumberTypes.Primary, cancellationToken: cancellationToken).ConfigureAwait(false);

        protected override async Task<bool> BeforeDeletingCardWithoutBackupAsync(INumberContext context, CancellationToken cancellationToken = default) =>
            await NumberHelper.GetNumberAndSetToContextPredicateAsync(context, NumberTypes.Primary, cancellationToken: cancellationToken).ConfigureAwait(false);

        protected override async Task<bool> BeforeDeletingBackupCardAsync(INumberContext context, CancellationToken cancellationToken = default) =>
            await NumberHelper.GetNumberAndSetToContextPredicateAsync(context, NumberTypes.Primary, cancellationToken: cancellationToken).ConfigureAwait(false);

        protected override async Task<bool> BeforeReservingNumberFromControlAsync(INumberContext context, CancellationToken cancellationToken = default) =>
            await NumberHelper.GetNumberAndSetToContextPredicateAsync(context, context.NumberObject.Type, cancellationToken: cancellationToken).ConfigureAwait(false);

        protected override async Task<bool> BeforeReleasingNumberFromControlAsync(INumberContext context, CancellationToken cancellationToken = default) =>
            await NumberHelper.GetNumberAndSetToContextPredicateAsync(context, context.NumberObject.Type, cancellationToken: cancellationToken).ConfigureAwait(false);
