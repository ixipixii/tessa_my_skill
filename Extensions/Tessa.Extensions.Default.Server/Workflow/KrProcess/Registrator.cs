    ...
    public sealed class Registrator : RegistratorBase
    {
        public override void RegisterUnity()
        {
            ...
            this.UnityContainer
                ...
                .RegisterType<KrSetDefaultSettingsValuesNewExtension>(new ContainerControlledLifetimeManager())
                ...
                .RegisterType<FixTaskHistoryCardStoreExtension>(new ContainerControlledLifetimeManager())
                ...
                .RegisterType<KrReassignAdditionalApprovalStoreExtension>(new ContainerControlledLifetimeManager())
        ...
        public override void RegisterExtensions(IExtensionContainer extensionContainer)
        {
            ...
            extensionContainer
                // смена родительско задания при делегировании для дополнительных согласований
                // должно выполняться строго после KrProcessWorkflowStoreExtension
            ...
            extensionContainer
                ...
                .RegisterExtension<ICardGetExtension, KrProcessExportExtension>(x => x
                    .WithOrder(ExtensionStage.AfterPlatform, 1)
                    .WithSingleton()
