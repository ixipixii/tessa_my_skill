...
namespace Tessa.Extensions.Default.Server.Workflow.KrProcess
{
    public sealed class OrderColumn : IEquatable<OrderColumn>
    {
            ...
            OrderColumn other)
        {
            ...
            return string.Equals(this.SectionName, other.SectionName, StringComparison.InvariantCulture) 
                && string.Equals(this.OrderFieldName, other.OrderFieldName, StringComparison.InvariantCulture);
        }
