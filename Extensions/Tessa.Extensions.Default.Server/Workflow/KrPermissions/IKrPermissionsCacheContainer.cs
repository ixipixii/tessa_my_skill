...
namespace Tessa.Extensions.Default.Server.Workflow.KrPermissions
{
    ...
    {
        /// <summary>
        /// Метод для получения объекта кеша правил доступа. Возвращает null и пишет ошибку в <paramref name="validationResult"/>, если не удалось получить объект кеша
        /// </summary>
        /// <param name="validationResult">Результат валидации, куда пишется ошибка, если неудалось загрузить кеш</param>
        /// <param name="cancellationToken">Токен отмены асинхронной операции</param>
        /// <returns>Возвращает объект кеша правил доступа, или null, если не удалось получить объект кеша</returns>
