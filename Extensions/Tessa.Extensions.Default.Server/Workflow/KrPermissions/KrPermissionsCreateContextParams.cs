...
namespace Tessa.Extensions.Default.Server.Workflow.KrPermissions
{
    ...
    {
        /// <summary>
        /// Карточка. Может быть не передана.
        /// </summary>
        ...
        /// <summary>
        /// Идентификатор карточки. Может быть не передан.
        /// </summary>
        ...
        /// <summary>
        /// Определяет, что нужно рассчитать обятательные права доступа
        /// </summary>
        public bool WithRequiredPermissions { get; set; }

        /// <summary>
        /// Определяет, что нужно рассчитать расширенные права доступа
        /// </summary>
