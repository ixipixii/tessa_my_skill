...
namespace Tessa.Extensions.Default.Server.Cards
{
    ...
    public static class OpenXmlHelper
    {
        ...
        /// <summary>
        /// Определяет константу для хранения позиции в Info плейсхолдера
        /// </summary>
        ...
        public static string TextPosition(IEnumerable<object> position)
        {
        ...
        public static bool IsLessOrEquals(IList<object> position1, IList<object> position2, bool resultOnCountMismatch = false)
        {
