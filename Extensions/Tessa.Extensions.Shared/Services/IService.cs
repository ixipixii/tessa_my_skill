...
namespace Tessa.Extensions.Shared.Services
{
    ...
    public interface IService
    {
        ...
        /// <param name="cancellationToken">Объект, посредством которого можно отменить асинхронную задачу.</param>
        /// <returns>Данные, возвращаемые методом.</returns>
        Task<string> GetDataWhenTokenInFirstParameterAsync(string token, string parameter, CancellationToken cancellationToken = default);
        ...
        Task<string> GetCardByIDAsync(Guid cardID, string cardTypeName = null, CancellationToken cancellationToken = default);
    }
}
