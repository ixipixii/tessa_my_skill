...
False, если запись соответствует контента на файловой системе.</Description>
	...
	<SchemePhysicalColumn ID="c61e4ed6-e550-4289-9673-394a2e668ce8" Name="UseSimpleNamingScheme" Type="Boolean Not Null">
...
Значение неактуально для файлов в базе данных.</Description>
		<SchemeDefaultConstraint IsPermanent="true" ID="3438d4f1-5b10-47a0-85eb-c1c7794c78b7" Name="df_FileSources_UseSimpleNamingScheme" Value="false" />
	</SchemePhysicalColumn>
