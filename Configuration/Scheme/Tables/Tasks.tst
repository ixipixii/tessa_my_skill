...
<SchemeTable IsSystem="true" IsPermanent="true" ID="5bfa9936-bb5a-4e8f-89a9-180bfd8f75f8" Name="Tasks" Group="System" InstanceType="Cards" ContentType="Collections">
	<Description>Задания, которые высланы на карточку.</Description>
	...
	<SchemeComplexColumn ID="a71c0f62-0662-46db-b046-a979d67936a9" Name="Role" Type="Reference(Typified) Not Null" ReferencedTable="81f6010b-9641-4aa5-8897-b8e8603fbf4b" WithForeignKey="false">
		<Description>Роль, на которую назначено задание.</Description>
		<SchemeReferencingColumn IsSystem="true" IsPermanent="true" ID="a71c0f62-0662-00db-4000-0979d67936a9" Name="RoleID" Type="Guid Not Null" ReferencedColumn="81f6010b-9641-01a5-4000-08e8603fbf4b" />
		<SchemeReferencingColumn ID="aceaaf35-dd26-48d2-812c-0d6ffd8e6d3f" Name="RoleName" Type="String(128) Not Null" ReferencedColumn="616d6b2e-35d5-424d-846b-618eb25962d0">
			<Description>Отображаемое имя роли.</Description>
		</SchemeReferencingColumn>
	</SchemeComplexColumn>
	<SchemeComplexColumn ID="33b75a5a-a5e3-402a-9a97-6542c414e45d" Name="RoleType" Type="Reference(Typified) Not Null" ReferencedTable="b0538ece-8468-4d0b-8b4e-5a1d43e024db">
		<Description>Тип карточки для роли.</Description>
		<SchemeReferencingColumn IsSystem="true" IsPermanent="true" ID="33b75a5a-a5e3-002a-4000-0542c414e45d" Name="RoleTypeID" Type="Guid Not Null" ReferencedColumn="a628a864-c858-4200-a6b7-da78c8e6e1f4">
			<Description>ID of a type.</Description>
		</SchemeReferencingColumn>
	</SchemeComplexColumn>
	...
	<SchemeComplexColumn ID="29922608-4475-4e9d-bb0b-38f3f24031b3" Name="Author" Type="Reference(Typified) Not Null" ReferencedTable="6c977939-bbfc-456f-a133-f1c2244e3cc3">
		<Description>Пользователь, являющийся автором задания.</Description>
		<SchemeReferencingColumn IsSystem="true" IsPermanent="true" ID="29922608-4475-009d-4000-08f3f24031b3" Name="AuthorID" Type="Guid Not Null" ReferencedColumn="6c977939-bbfc-016f-4000-01c2244e3cc3" />
		<SchemeReferencingColumn ID="b8dad8a3-fe53-4a54-8eb1-8c689b3ecc77" Name="AuthorName" Type="String(128) Not Null" ReferencedColumn="1782f76a-4743-4aa4-920c-7edaee860964">
			<Description>Отображаемое имя пользователя.</Description>
		</SchemeReferencingColumn>
		<SchemeReferencingColumn ID="5cc99b20-1cd3-451c-9850-861bb2c9ca15" Name="AuthorPosition" Type="String(256) Null" ReferencedColumn="6ca55e0c-c14c-465f-8fdc-f585ae35df09">
	...
	<SchemePhysicalColumn ID="e9004f1f-b688-433a-8f3d-0b16935227b4" Name="HiddenFromAuthor" Type="Boolean Not Null">
		<Description>Признак того, что задание скрыто от автора.</Description>
	</SchemePhysicalColumn>
	<SchemePhysicalColumn ID="653735ee-cb40-402e-a233-ec908031dfe3" Name="Digest" Type="String(4000) Null">
	...
	<SchemePhysicalColumn ID="dd3c91e5-0dc1-49a2-8837-3e98974061b1" Name="Settings" Type="String(Max) Null" />
	...
	<SchemeIndex ID="0801efc4-af03-4f2f-b8f5-768bd4d69486" Name="ndx_Tasks_RoleID">
		<SchemeIndexedColumn Column="a71c0f62-0662-00db-4000-0979d67936a9" />
	</SchemeIndex>
	...
	<SchemeIndex ID="27903bcf-1f1e-4bdd-ae54-82a1c8ceda8b" Name="ndx_Tasks_Modified">
		...
		<SchemeIncludedColumn Column="5bfa9936-bb5a-008f-3100-080bfd8f75f8" />
		<SchemeIncludedColumn Column="a71c0f62-0662-00db-4000-0979d67936a9" />
	...
	<SchemeIndex ID="5748a910-a196-45ac-96f1-c5a8f8caf7c6" Name="ndx_Tasks_AuthorID">
		<SchemeIndexedColumn Column="29922608-4475-009d-4000-08f3f24031b3" />
		<SchemeIncludedColumn Column="5bfa9936-bb5a-008f-3100-080bfd8f75f8" />
