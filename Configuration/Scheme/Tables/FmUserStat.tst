...
<SchemeTable ID="d10d18eb-d803-4151-8a60-8bfd262d2800" Name="FmUserStat" Group="Fm" InstanceType="Cards" ContentType="Collections">
	<Description>Таблица в который храним дату посящения пользователя топика</Description>
	...
	<SchemePhysicalColumn ID="1951f9f5-4db0-4e47-9f01-fa6c1aef7c99" Name="LastReadMessageTime" Type="DateTime Null">
		<Description>Дата последняя прочитанного сообщения</Description>
	...
	<SchemeIndex ID="28e9852d-927c-449c-a03d-59c2a5bf240e" Name="ndx_FmUserStat_UserIDTopicRowID">
