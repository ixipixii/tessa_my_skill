...
<SchemeTable IsSystem="true" IsPermanent="true" ID="6c977939-bbfc-456f-a133-f1c2244e3cc3" Name="PersonalRoles" Group="Roles" InstanceType="Cards" ContentType="Entries">
	...
	<SchemeComplexColumn ID="7265c20d-ce25-4e35-8f6d-edc343f6d68b" Name="Gender" Type="Reference(Typified) Null" ReferencedTable="71032cb4-2c7b-43d3-9330-96e9aee23bdb">
		<Description>Пол сотрудника.</Description>
		<SchemeReferencingColumn IsSystem="true" IsPermanent="true" ID="7265c20d-ce25-0035-4000-0dc343f6d68b" Name="GenderID" Type="Int16 Null" ReferencedColumn="30da2be3-3839-47ab-bb6c-5bdb816bf597">
...
Для хеширования используется функция HMAC-SHA256, размер хеша в которой 256 бит или 32 байта.</Description>
	...
	<SchemePhysicalColumn ID="5a97bd3d-9dab-4724-9590-24c8c7f7395e" Name="Security" Type="Binary(Max) Null">
		<Description>Объект UserSecurityObject, сериализованный в BSON, содержит информацию по предыдущим попыткам входа и по ранее заданным паролям.&#xD;
Поле можно сбросить Null, чтобы очистить такую информацию, при следующем входе в систему поле будет заполнено.</Description>
	</SchemePhysicalColumn>
	<SchemePhysicalColumn ID="e09af0be-c482-4781-a9ff-3de01d424404" Name="SecurityLock" Type="Boolean Not Null">
		<Description>Признак того, что в данный момент выполняется чтение или запись объекта с настройками из поля Security.</Description>
		<SchemeDefaultConstraint IsPermanent="true" ID="019b3216-ff25-4f61-91cc-8ce3166300bb" Name="df_PersonalRoles_SecurityLock" Value="false" />
	</SchemePhysicalColumn>
