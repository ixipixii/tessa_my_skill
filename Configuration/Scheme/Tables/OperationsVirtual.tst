...
<SchemeTable ID="a87294b1-0c66-41bc-98e8-765dfb8dcf56" Name="OperationsVirtual" Group="System" IsVirtual="true" InstanceType="Cards" ContentType="Entries">
	<Description>Виртуальная карточка "Операция". Колонки аналогичны таблице Operations (активные операции).</Description>
	...
	<SchemePhysicalColumn ID="dff5b666-8025-46ff-b125-1d32163b65a6" Name="RequestBinary" Type="Binary(Max) Null">
	...
	<SchemePhysicalColumn ID="37728d3b-0e3b-4ba3-a232-498eb8031060" Name="ResponseBinary" Type="Binary(Max) Null">
