...
False, если запись соответствует контента на файловой системе.</Description>
	...
	<SchemePhysicalColumn ID="166f9d49-03b9-4469-8099-7b422c5aa398" Name="UseSimpleNamingScheme" Type="Boolean Not Null">
		<Description>Признак того, что используется упрощённая схема именования папок, где для карточек не создаются дополнительные подпапки.&#xD;
&#xD;
Значение True не рекомендуется, если в системе возможны миллионы карточек с файлами,&#xD;
т.к. это приведёт к миллионам подпапок внутри одной папки в файловой системе.&#xD;
&#xD;
Значение неактуально для файлов в базе данных.</Description>
		<SchemeDefaultConstraint IsPermanent="true" ID="2d6d5180-15ce-45a0-a190-165929601b98" Name="df_FileSourcesVirtual_UseSimpleNamingScheme" Value="false" />
	</SchemePhysicalColumn>
